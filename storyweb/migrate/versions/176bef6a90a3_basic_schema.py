...
def upgrade():
    ...
    op.create_table('card',
        ...
        sa.Column('category', sa.Enum('Person', 'Company', 'Organization', 'Article', name='card_categories'), nullable=False),
    ...
    op.create_table('link',
        ...
        sa.Column('status', sa.Enum('pending', 'approved', 'rejected', name='link_statuses'), nullable=False),
        sa.Column('author_id', sa.Integer(), nullable=True),
